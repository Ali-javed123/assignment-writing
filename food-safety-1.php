<?php include('header.php');?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white mb-0">Free Samples of Food Safety Management
        ...
        <!--hero section end-->
        <div class="container ">
            <h2 class="text-center">Get the Best Food Safety Management to Improve Your Grade
            </h2>
            <i class="fas fa-arrow-circle-down"></i>
            <div class="row row-4 justify-content-center">
                <div class="col-md-6 text card">
                    <!-- sub row start -->
                    <h3 class="text-center"><a href="food-2.php">Food Pacakaging And Sensory Ananlysis:</a></h3>
                    <div class="row">
