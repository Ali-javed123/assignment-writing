<?php include('header.php');?>
    ...
    <div class="main">
        ...
        <!--hero section end-->
        <div class="container ">
          <h2 class="text-center">Get the Best Managing People and Careers to Improve Your Grade
        ...
        <i class="fas fa-arrow-circle-down"></i>
          <div class="row row-4 justify-content-center">
            <div class="col-md-6 text card">
                <!-- sub row start -->
                <h3 class="text-center"><a href="managing-people-career-2.php">Managing People And Careers:</a></h3>
                <div class="row">
                    <div class="col-md-8">
