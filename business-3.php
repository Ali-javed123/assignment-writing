<?php include('header.php');?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white mb-0">Improving Business Performance 6LO500 Spring Term 2017 University of Derby
                            </h2>
        ...
        <div class="container">
            <h3>Report on Improving Business Performance 6LO500 Spring Term 2017 University of Derby
            </h3>
            <h2>Improving Business Performance 6LO500 Spring Term 2017 University of Derby
            </h2>
