<?php include('header.php');?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white mb-0">Free Samples of Mathematics
                            </h2>
        ...
        <!--hero section end-->
        <div class="container ">
          <h2 class="text-center">Get the Best Mathematics to Improve Your Grade
        ...
        <i class="fas fa-arrow-circle-down"></i>
          <div class="row row-4 justify-content-center">
            <div class="col-md-6 text-c card">
                <!-- sub row start -->
                <h3 class="text-center"><a href="mathametic-2.php">Numercy:</a></h3>
                <div class="row">
                    <div class="col-md-8">
