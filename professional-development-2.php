<?php include('header.php');?>
    ...
    <div class="main">
        ...
        <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white mb-0">Professional Development and Practice
                            </h2>
            ...
            <!-- paragraph start -->
            <div class="container">
                <h3 class="text-danger text-center" style="border-bottom: 12px solid black;">Report on Professional
