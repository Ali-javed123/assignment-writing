<?php include('header.php');?>
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                            <h2 class="text-white mb-0">Violent Video Games Cause Behavioural Problems
                            </h2>
        ...
        <br>
              ...
              <!--promo section start-->
              <div class="container">
                <h3 class="text-center text-danger" style="border-bottom: 12px solid black;"> Report on Religious Beliefs and Values Level 4
                </h3>
               <h5>Introduction</h5>
